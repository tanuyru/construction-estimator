...
export default function NewAreaCard(props) {
  ...
  async function newArea(){
    const newAreaName = (document.getElementById("newAreaInput") as HTMLInputElement)?.value;
    const newAreaSize = parseFloat((document.getElementById("newAreaSizeSqFt") as HTMLInputElement)?.value);
